...
TroveboxAction.prototype.create = function(photoid, opts, callback) {
        if (typeof callback === 'undefined') {
            callback = opts;
            opts = {};
        }
        var request = {url:this.parent.host+'/action/'+photoid+'/photo/create.json', oauth:this.parent.oauth, form:opts};
        this.parent.post(request, callback)
}

TroveboxAction.prototype.delete = function(photoid, callback) {
        var request = {url:this.parent.host+'/action/'+photoid+'/delete.json', oauth:this.parent.oauth};
        this.parent.post(request, callback)
}
...
TroveboxPhoto.prototype.delete = function(photoid, callback) {
        var request = {url:this.parent.host+'/photo/'+photoid+'/delete.json', oauth:this.parent.oauth};
        this.parent.post(request, callback)
}
...
TroveboxTag.prototype.create = function(tag, opts ,callback) {
        if (typeof callback === 'undefined') {
            callback = opts;
            opts = {};
        }

        _.extend(opts,{tag:tag})

        var request = {url:this.parent.host+'/tag/create.json', oauth:this.parent.oauth, form:opts};
        this.parent.post(request, callback)
}

TroveboxTag.prototype.update = function(tagid, opts ,callback) {
        if (typeof callback === 'undefined') {
            callback = opts;
            opts = {};
        }

        var request = {url:this.parent.host+'/tag/'+tagid+'/update.json', oauth:this.parent.oauth, form:opts};
        this.parent.post(request, callback)
}
